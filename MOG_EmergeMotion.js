...
/*:ja
@target MZ
@plugindesc (v1.0) 敵が出現するアニメーションを追加します。
@author Moghunter
@url https://mogplugins.wordpress.com
@license https://mogplugins.com/terms-of-use/
...
メモタグ
======================================================================
出現アニメを有効にするには、以下のメモタグを入力してください。
...
/*:en
@target MZ
@plugindesc (v1.0) Adds animation of enemies emerging.
@author Moghunter
@url https://mogplugins.wordpress.com
@license https://mogplugins.com/terms-of-use/
...
https://mogplugins.wordpress.com
=============================================================================
Adds the animation of enemies emerging.

=============================================================================
NOTETAGS
=====================================================================================
Enter the comment below to activate the emerge movements.
...
@param Initial Wait
@text Initial Wait
@desc Initial time to activate the movement.
@default 30
@type number
@min 5
...
@param Wait for the Next
@text Wait for the Next
@desc Time to activate movement between one battler and another.
@default 20
@type number
@min 5
*/
