...
/*:en
@target MZ
@plugindesc (v1.0) Allows you to customize the target cursor image.
@author Moghunter
@url https://mogplugins.com
...
https://mogplugins.wordpress.com
=============================================================================
Allows you to customize the destination cursor image.
- Animation by image frames.
- Smooth movement.
- Allows you to enable or disable zoom or fade effects.
...
Save the image to the folder (img/system/)

@param Show Default Cursor
@text Show Default Cursor
@desc Display the default cursor.
@default true
@type boolean
...
@desc Enable smooth motion.
@default true
@type boolean

@param Zoom Animation
@text Zoom Animation
@desc Enable zoom animation.
@default false
@type boolean

@param Blink Animation
@text Blink Animation
@desc Enable blinking animation.
@default false
@type boolean

@param Float Animation
@text Float Animation
@desc Enable levitation animation.
@default true
@type boolean

@param Blend Mode
@text Blend Mode
@desc Blend mode setting. (0..2)
@default 0

@param Rotation Speed
@text Rotation Speed
@desc Setting the image rotation speed.
@default 0

@param Number of Frames
@text Number of Frames
@desc Defines the number of image frames. The image will be divided by the number of frames.
@default 1

@param Animation Speed
@text Animation Speed
@desc Setting the frame animation speed.
@default 4
*/

/*:ja
@target MZ
@plugindesc (v1.0) 目的地ポインターの画像をカスタマイズできます。
@author Moghunter
@url https://mogplugins.com
@license https://mogplugins.com/terms-of-use/
...
https://mogplugins.wordpress.com
=============================================================================
目的地ポインターの画像をカスタマイズできます。
- 画像フレームによるアニメーション
- スムーズな動き。
- ズーム効果またはフェード効果を有効または無効にできます。
...
@param Number of Frames
@text フレーム数
@desc 画像フレームの数を定義。画像はフレーム数で分割されます。
@default 1

@param Animation Speed
@text アニメーション速度
@desc フレームアニメーションの速度を設定
@default 4
*/
